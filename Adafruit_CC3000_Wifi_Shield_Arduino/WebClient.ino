...
#define WLAN_SSID       "OpenFCT"           // cannot be longer than 32 characters!
...
// What page to grab!
#define WEBSITE      "10-22-240-187.uninova.openfct.fct.unl.pt"
#define WEBPAGE      "/CloudTest/Xav13ruaPRO"
#define COMPLETEPAGE "10-22-240-187.uninova.openfct.fct.unl.pt:8080/CloudTest/Xav13ruaPRO"
//#define WEBPAGE      "/examples/servlets/servlet/RequestInfoExample"
...
void setup(void)
{
  ...
  if (www.connected()) {
    ...
    www.fastrprint(F("Host: 10-22-240-187.uninova.openfct.fct.unl.pt:8080\r\n"));
